...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_OrangeHRM/input_txtPassword'), 'VbrFuoay8tg=')
...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/amenu__Performance'))
